 ...
 */
define( 'LDX_DESIGN_UPGRADE_LEARNDASH_VERSION', '1.4.6' );
...
function ldx_design_upgrade_learndash_enqueue_css() {
	...
	wp_enqueue_style( 'ldx-design-upgrade-learndash', plugins_url( 'assets/css/learndash.css', __FILE__ ), array( 'learndash_style', 'sfwd_front_css', 'learndash_pager_css', 'learndash_template_style_css', 'learndash_quiz_front_css' ), '1.4.6' );
